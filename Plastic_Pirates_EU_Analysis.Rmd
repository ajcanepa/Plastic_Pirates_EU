...
After meeting and email fro Charlotte, we realise that NA in group B for some items it's really a zero. So we update these columns replacing `NA` values with a `0`.
