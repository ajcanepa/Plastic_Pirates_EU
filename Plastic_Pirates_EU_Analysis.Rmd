...
Average_litter_type <- 
  ...
  labs(x = "",  y = expression(Litter~abundance~"(mean" %+-% SD~")"), title = '', subtitle = "") +
  theme_classic() +
...
```{r, echo=FALSE, eval=FALSE}
# Save the plot
ggsave(filename = "Average_SUP_Country_GroupB.png", plot = SUP_Average_litter_type_country, path = paste(getwd(), "/OUTPUT/FIGURES", sep = ""), scale = 1.5, width = 40, height = 30, units = "cm", dpi = 150, limitsize = FALSE)
```
